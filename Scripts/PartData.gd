...
enum MaterialSound{ DEFAULT = 0, FABRIC = 1, GLITCH = 2, HAIR = 3, METAL = 4, PLASTIC = 5, RUBBER  = 6, SHELL = 7, SOUP = 8, SQUISHY = 9, STICKER = 10 }
...
@export_enum("Default:0", "Fabric:1", "Glitch:2", "Hair:3", "Metal:4", "Plastic:5", "Rubber:6", "Shell:7", "Soup:8", "Squishy:9", "Sticker:10") var materialSound: int = 0