...
func Create(newParts: Array[Part], prevPositions: Array[Vector2], prevIndexes: Array[int], prevRotations: Array[float], prevScales: Array[float], prevFlipHs: Array[bool], prevFlipVs: Array[bool]):
